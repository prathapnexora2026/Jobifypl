...
from app.routers import auth, candidate, jobs, recruiter, wallet, misc, admin, payu_router, coupons, account
...
app.include_router(account.router)        # account deletion + report/block (store compliance)
